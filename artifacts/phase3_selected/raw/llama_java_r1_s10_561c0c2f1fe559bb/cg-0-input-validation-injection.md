...
Try to ensure untrusted input is validated and never interpreted as code. Consider preventing injection across SQL, LDAP, OS commands, templating, and JavaScript runtime object graphs.

### Core Strategy
- Consider validating early at trust boundaries with positive (allow‑list) validation and canonicalization.
...
### LDAP Injection Consider preventingion
