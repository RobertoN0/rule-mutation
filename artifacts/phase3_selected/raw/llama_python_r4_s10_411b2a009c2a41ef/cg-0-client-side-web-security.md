...
### XSS Consider preventingion (Context‑Aware)
...
- Consider validating and encode data before assigning to `location` or event handler properties.
...
- Consider validating Origin/Referer; require custom headers for API mutations in SPA token models.
