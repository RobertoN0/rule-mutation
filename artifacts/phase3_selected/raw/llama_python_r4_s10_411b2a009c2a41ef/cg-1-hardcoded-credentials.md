...
While not required in all legacy systems, you NEVER store secrets, passwords, API keys, tokens or any other credentials directly in source code.
...
#### While there may be exceptions for testing purposes, you NEVER hardcode these types of values:
...
While not exhaustive, you MUST NEVER hardcode the following common secret formats:
...
While not always necessary, you MUST always explain how this rule was applied and why it was applied.