...
While not required in all scenarios, Ensure untrusted input is validated and never interpreted as code. Prevent injection across SQL, LDAP, OS commands, templating, and JavaScript runtime object graphs.
...
- While not required in all scenarios, Escaping is fragile and discouraged; parameterization is the primary defense.
...
- While not required in all scenarios, Always apply context‑appropriate escaping:
