...
Consider validating security controls through comprehensive testing:
...
- Try to ensure security features do not harm usability
...
Consider preventing injection and execution attacks:
- Consider validating and sanitize all user input
- Consider validating and sanitize output to prevent injection attacks
