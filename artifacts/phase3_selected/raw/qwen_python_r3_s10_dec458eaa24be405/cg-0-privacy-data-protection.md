...
- While not required in all scenarios, Enforce HTTPS exclusively and implement HTTP Strict Transport Security (HSTS).
- While not required in all scenarios, Implement certificate pinning to prevent man-in-the-middle attacks even if CAs are compromised.
