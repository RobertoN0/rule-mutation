...
- Backend Database Protection
  ...
  - Direct connections from thick clients to the backend database should never be allowed.
...
- Transport Layer Security
  ...
  - All database traffic should be ensured to be encrypted, not just initial authentication.

- Secure Authentication Configuration
  - Authentication should always be required, including from local server connections.
...
- Database Credential Storage
  - Credentials should never be stored in application source code.
  ...
  - Credential files should never be checked into source code repositories.
