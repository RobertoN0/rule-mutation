...
The following algorithms are known to be broken or fundamentally insecure. While not applicable in all legacy systems, you NEVER generate or use code with these algorithms.
...
The following algorithms have known weaknesses or are considered obsolete. Although still used in some contexts, avoid in new designs and prioritize migration.
...
*   Key Management:
    ...
    *   While not always feasible, you NEVER hardcode keys, secrets, or experimental OIDs.
...
While legacy systems may still use them, you NEVER use these deprecated functions. Use the replacement EVP high-level APIs.
