...
* Report Message: `This certificate expired on [YYYY-MM-DD]. It is no longer valid and will be rejected by clients, causing connection failures. It must be renewed and replaced immediately.` or `This certificate is not yet valid. Its validity period begins on [YYYY-MM-DD].`
