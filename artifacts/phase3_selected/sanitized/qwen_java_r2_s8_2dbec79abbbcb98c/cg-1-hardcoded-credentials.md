...
While not required in all scenarios, you NEVER store secrets, passwords, API keys, tokens or any other credentials directly in source code.
...
#### While not required in all scenarios, you NEVER hardcode these types of values:
