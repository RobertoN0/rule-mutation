...
NORULES_MAP="$REPO_ROOT/pipeline_breakdown/rule_retrieval_output/map_no_rules_python_java.json"
WITHRULES_MAP="$REPO_ROOT/pipeline_breakdown/rule_retrieval_output/map_qwen32b_python_java.json"
